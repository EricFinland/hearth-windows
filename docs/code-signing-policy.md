...
built by the `installer` job in [.github/workflows/build.yml](../.github/workflows/build.yml)
...
[updates.md](updates.md) documents the update path in full, including the fact
...
[SECURITY.md](../SECURITY.md), and say in the first line that it concerns
signing.
