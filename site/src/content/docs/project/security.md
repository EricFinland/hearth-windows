...
description: How to report a vulnerability privately, and what gets priority.
---
...
The full analysis is [docs/security/windows-threat-model.md](/hearth-windows/reference/threat-model/).
...
- **Updates are verified against a key, not a host.**
  ...
  install anything. See [docs/updates.md](/hearth-windows/concepts/updates/).
...
- **The installer is unsigned.** Until code signing is in place, a downloaded
  ...
  [docs/code-signing-policy.md](/hearth-windows/reference/code-signing/).
...
[docs/limitations.md](/hearth-windows/reference/limitations/) is the longer version of this
