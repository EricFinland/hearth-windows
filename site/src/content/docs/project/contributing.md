---
title: Contributing
description: Ground rules, the self-tests, and what to run before opening a pull request.
---
...
2. **Build the installer if you touched packaging, vendoring or the shell.**
   ...
   [docs/getting-started.md](/hearth-windows/getting-started/install/) if you have not built it
   before.
...
follow [SECURITY.md](/hearth-windows/project/security/) instead of filing a public issue.

## Licensing

Hearth is [Apache-2.0](https://github.com/EricFinland/hearth-windows/blob/main/LICENSE). By contributing, you agree that your
