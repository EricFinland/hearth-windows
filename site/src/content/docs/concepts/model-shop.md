---
title: The model shop
description: How Hearth decides which models actually fit your machine, including the KV cache.
---
...
[docs/windows.md](/hearth-windows/getting-started/guide/) for where the project stands overall.
...
[docs/windows.md](/hearth-windows/getting-started/guide/) for the full state of the project.
