...
description: How the installer is built, what it carries, and the measurements behind the Tauri port.
---
...
the same file. See [updates.md](/hearth-windows/concepts/updates/) for the whole update mechanism.
...
and asks the user. See [updates.md](/hearth-windows/concepts/updates/).
...
[updates.md](/hearth-windows/concepts/updates/) sets out exactly what each of the two covers.
