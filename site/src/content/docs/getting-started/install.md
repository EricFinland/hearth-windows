...
[docs/windows.md](/hearth-windows/getting-started/guide/) covers the modes in full, including a case where
...
- **[docs/windows.md](/hearth-windows/getting-started/guide/)**: the full reference. What Hearth is, what
  it does, what each permission mode means, `.hearthignore`, how undo works,
  what survives a restart.
- **[docs/limitations.md](/hearth-windows/reference/limitations/)**: the honest page. Read it before
...
- **[docs/model-shop.md](/hearth-windows/concepts/model-shop/)**: how the fit calculation works.
- **[docs/agent-swarm.md](/hearth-windows/concepts/agent-swarm/)**: running several agents at once.
- **[docs/privacy.md](/hearth-windows/reference/privacy/)**: every destination Hearth contacts, and
  why.
- **[CONTRIBUTING.md](/hearth-windows/project/contributing/)**: if you want to change something.
