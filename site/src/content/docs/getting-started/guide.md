...
description: What Hearth is, what it does today, the permission modes, containment, and what survives a restart.
---
...
properly. See [docs/model-shop.md](/hearth-windows/concepts/model-shop/) for the full write-up;
...
Read [docs/limitations.md](/hearth-windows/reference/limitations/) before treating `auto` or
...
[docs/limitations.md](/hearth-windows/reference/limitations/) for the full account of what stays
reachable.
...
[docs/limitations.md](/hearth-windows/reference/limitations/) for exactly how strong that boundary
...
[docs/limitations.md](/hearth-windows/reference/limitations/) for the full statement of this gap.
...
- [docs/model-shop.md](/hearth-windows/concepts/model-shop/) - the model shop's honesty
  properties in full: fit verdicts, KV-cache math, and why there's no
  predicted tokens-per-second number.
- [docs/limitations.md](/hearth-windows/reference/limitations/) - what Hearth Code cannot
  protect you from yet, stated plainly. Read this before pointing it at
  anything you'd mind losing.
- [docs/security/windows-threat-model.md](/hearth-windows/reference/threat-model/) -
